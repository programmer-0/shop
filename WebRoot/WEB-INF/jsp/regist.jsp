...
<script>
	function checkForm() {
		...
		if (repassword == null || repassword == "") {
			document.getElementById("checkrepassword").innerHTML = "确认密码不能为空";
			return false;
		}
		...
		if (repassword != password) {
			document.getElementById("checkrepassword").innerHTML = "两次输入的密码不一致";
			return false;
		}
	}
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" name="name"
										class="text" maxlength="200"><span><s:fielderror fieldName="name" /></span></td>
								</tr>
								<tr>
									<th>性别:</th>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text" id="checkCode" name="checkCode" class="text captcha"
											maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" title="点击更换验证码" onclick="change()"></span><span><s:actionerror /></span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
